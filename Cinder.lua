------------------------------------------------
-- This Source Was Developed By (Lar) @I74III.--
--   This Is The Source Channel @I74III .   --
--           - Source Dove -                 --
--        -- https://t.me/I74III --         --
------------------------------------------------ 
...
local TheCinder = io.open("TheCinder", 'w')
TheCinder:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Cinder.lua
done
]])
TheCinder:close()
...
screen -S ]]..Redis:get(SshId.."Info:Redis:Token:User")..[[ ./TheCinder
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheCinder;chmod +x Run;./Run')
end
...
TheCinder = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheCinder)
LuaTele = luatele.set_config{ api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheCinder,token=Token }
function var(value)  
...
ControllerAll = false
local ListSudos ={ Sudo_Id,1884478855 }  
...
Status = 0
DevelopersQ = Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId) 
if UserId == 1884478855 then
Status = true
elseif UserId == 1884478855 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheCinder then
Status = true
...
Status = 0
Developers = Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheCinder.."Cinder:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheCinder.."Cinder:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheCinder.."Cinder:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TheCinder.."Cinder:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheCinder.."Cinder:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheCinder.."Cinder:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheCinder.."Cinder:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheCinder.."Cinder:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheCinder.."Cinder:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعة'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعة'
elseif Distinguished then
Status = Redis:get(TheCinder.."Cinder:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheCinder.."Cinder:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheCinder.."Cinder:lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(TheCinder.."Cinder:Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(TheCinder.."Cinder:Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(TheCinder.."Cinder:Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(TheCinder.."Cinder:Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(TheCinder.."Cinder:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheCinder.."Cinder:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheCinder.."Cinder:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheCinder.."Cinder:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(TheCinder.."Cinder:Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(TheCinder.."Cinder:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheCinder.."Cinder:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(TheCinder.."Cinder:Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(TheCinder.."Cinder:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(TheCinder.."Cinder:Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheCinder.."Cinder:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(TheCinder.."Cinder:Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(TheCinder.."Cinder:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheCinder.."Cinder:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(TheCinder.."Cinder:Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(TheCinder.."Cinder:Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(TheCinder.."Cinder:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheCinder.."Cinder:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(TheCinder.."Cinder:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{ 
BanAll = Redis:sismember(TheCinder.."Cinder:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..ChatId,UserId)
 }
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheCinder).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheCinder..'Cinder:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheCinder) then
...
if tonumber(msg.sender.user_id) == 1884478855 then
...
elseif Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheCinder.."Cinder:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheCinder.."Cinder:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheCinder.."Cinder:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheCinder) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheCinder.."Cinder:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheCinder.."Cinder:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheCinder.."Cinder:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheCinder.."Cinder:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheCinder) then
return false
end
local floods = Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheCinder.."Cinder:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheCinder.."Cinder:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheCinder.."Cinder:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheCinder.."Cinder:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{ 1,0,0,0,0,0,0,0,0 })
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
elseif Redis:get(TheCinder.."Cinder:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheCinder.."Cinder:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheCinder.."Cinder:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheCinder.."Cinder:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheCinder.."Cinder:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheCinder.."Cinder:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{ [1]= msg.id })
return false
end
...
Redis:incr(TheCinder.."Cinder:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheCinder.."Cinder:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheCinder.."Cinder:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheCinder.."Cinder:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheCinder.."Cinder:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheCinder.."Cinder:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheCinder.."Cinder:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheCinder.."Cinder:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheCinder.."Cinder:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheCinder.."Cinder:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheCinder.."Cinder:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheCinder.."Cinder:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheCinder.."Cinder:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheCinder.."Cinder:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheCinder.."Cinder:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheCinder.."Cinder:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheCinder.."Cinder:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheCinder.."Cinder:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheCinder.."Cinder:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheCinder.."Cinder:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheCinder.."Cinder:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheCinder.."Cinder:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheCinder.."Cinder:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheCinder.."Cinder:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheCinder.."Cinder:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheCinder.."Cinder:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheCinder.."Cinder:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheCinder.."Cinder:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheCinder.."Cinder:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheCinder.."Cinder:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheCinder.."Cinder:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheCinder.."Cinder:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheCinder.."Cinder:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheCinder.."Cinder:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheCinder.."Cinder:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheCinder.."Cinder:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheCinder.."Cinder:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheCinder.."Cinder:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheCinder.."Cinder:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheCinder.."Cinder:Command:List:Group"..msg_chat_id,text)
Redis:del(TheCinder.."Cinder:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الامر باسم ↫ ‹ "..text..' ›',"md",true)
end
if Redis:get(TheCinder.."Cinder:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheCinder.."Cinder:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheCinder.."Cinder:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheCinder.."Cinder:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheCinder.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheCinder.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheCinder.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheCinder.."Cinder:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعة","md",true)     
end
if Redis:get(TheCinder.."Cinder:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheCinder.."Cinder:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheCinder.."Cinder:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheCinder.."Cinder:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ قوانين المجموعة","md",true)  
end  
if Redis:get(TheCinder.."Cinder:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheCinder.."Cinder:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheCinder.."Cinder:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ رد للمدير بنجاح \n᥀︙ارسل ( "..test.." ) لرؤية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheCinder.."Cinder:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheCinder.."Cinder:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheCinder.."Cinder:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheCinder.."Cinder:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheCinder..'Cinder:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheCinder.."Cinder:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheCinder.."Cinder:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheCinder..'Cinder:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheCinder.."Cinder:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheCinder.."Cinder:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheCinder.."Cinder:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheCinder.."Cinder:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheCinder.."Cinder:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheCinder.."Cinder:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheCinder.."Cinder:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل لي الرد سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ›
...
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheCinder..'Cinder:'..v..text)
end
Redis:del(TheCinder.."Cinder:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheCinder.."Cinder:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheCinder.."Cinder:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheCinder.."Cinder:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheCinder.."Cinder:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheCinder.."Cinder:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheCinder..'Cinder:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheCinder.."Cinder:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheCinder.."Cinder:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheCinder.."Cinder:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheCinder.."Cinder:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheCinder..'Cinder:GetTexting:DevTheCinder'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ᥀' then 
Redis:del(TheCinder..'Cinder:GetTexting:DevTheCinder'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheCinder..'Cinder:Texting:DevTheCinder',text)
Redis:del(TheCinder..'Cinder:GetTexting:DevTheCinder'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم حفظ كليشة المطور')
end
if Redis:get(TheCinder.."Cinder:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == 'الغاء الامر ᥀' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheCinder.."Cinder:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheCinder.."Cinder:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheCinder.."Cinder:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheCinder.."Cinder:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == 'الغاء الامر ᥀' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheCinder.."Cinder:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheCinder.."Cinder:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheCinder.."Cinder:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(TheCinder.."Cinder:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheCinder.."Cinder:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheCinder.."Cinder:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheCinder.."Cinder:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(TheCinder.."Cinder:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheCinder.."Cinder:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheCinder.."Cinder:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheCinder.."Cinder:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Smile"..msg.chat_id) then
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheCinder.."Cinder:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheCinder.."Cinder:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Monotonous"..msg.chat_id) then
Redis:del(TheCinder.."Cinder:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheCinder.."Cinder:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheCinder.."Cinder:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheCinder.."Cinder:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheCinder.."Cinder:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheCinder.."Cinder:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheCinder.."Cinder:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheCinder.."Cinder:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذراً لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheCinder.."Cinder:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheCinder.."Cinder:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheCinder.."Cinder:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n᥀︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheCinder.."Cinder:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheCinder.."Cinder:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheCinder.."Cinder:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheCinder.."Cinder:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheCinder.."Cinder:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Difference"..msg.chat_id) then 
Redis:del(TheCinder.."Cinder:Game:Difference"..msg.chat_id)
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheCinder.."Cinder:Game:Example"..msg.chat_id) then
if text == Redis:get(TheCinder.."Cinder:Game:Example"..msg.chat_id) then 
Redis:del(TheCinder.."Cinder:Game:Example"..msg.chat_id)
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼𝖪 𝖧𝖾𝗋𝖾 ›', url = 't.me/'..Redis:get(TheCinder..'Cinder:Channel:Join') }, }, } }
...
if tonumber(TheCinder) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheCinder..'Cinder:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheCinder.."Cinder:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheCinder.."Cinder:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheCinder.."Cinder:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheCinder.."Cinder:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheCinder) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheCinder.."Cinder:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheCinder.."Cinder:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheCinder.."Cinder:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheCinder..'Cinder:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ᥀' then 
Redis:del(TheCinder..'Cinder:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheCinder).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheCinder..'Cinder:Channel:Join',ChannelUser) 
...
Redis:set(TheCinder..'Cinder:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheCinder..'Cinder:Channel:Join')
...
os.execute('rm -rf Cinder.lua')
download('https://raw.githubusercontent.com/CinderTeam/Cinder/master/Cinder.lua','Cinder.lua')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙تم تحديث سورس كاوي الى الاصدار الجديد* ',"md",true)  
end
...
Redis:del(TheCinder.."Cinder:SendBcBot") 
...
Redis:set(TheCinder.."Cinder:SendBcBot",true) 
...
Redis:del(TheCinder.."Cinder:LeftBot") 
...
Redis:set(TheCinder.."Cinder:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheCinder.."Cinder:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheCinder.."Cinder:AddSudosNew"..msg_chat_id)
...
Redis:set(TheCinder.."Cinder:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheCinder..'Cinder:ChekBotAdd')  
local UsersBot = Redis:smembers(TheCinder..'Cinder:Num:User:Pv')  
local Get_Json = '{ "BotId": '..TheCinder..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheCinder.."Cinder:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheCinder.."Cinder:Originators:Group"..v)
local Manager = Redis:smembers(TheCinder.."Cinder:Managers:Group"..v)
local Admin = Redis:smembers(TheCinder.."Cinder:Addictive:Group"..v)
local Vips = Redis:smembers(TheCinder.."Cinder:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{ '
else
Get_Json = Get_Json..',"'..v..'":{ '
...
listrep = Redis:smembers(TheCinder.."Cinder:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,' }','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheCinder.."Cinder:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheCinder.."Cinder:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheCinder.."Cinder:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheCinder..'Cinder:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙عدد المجموعات : '..(Redis:scard(TheCinder..'Cinder:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheCinder..'Cinder:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheCinder.."Cinder:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheCinder..'Cinder:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعة  يجب ان يكوم اكثر من :'..Redis:get(TheCinder..'Cinder:Num:Add:Bot'),"md",true)  
end
...
{ 
{ text = '‹ TeAm Cinder ›', url = 't.me/RR77FF' },
 },
 }
 }
if not msg.ControllerBot then
...
Redis:sadd(TheCinder.."Cinder:ChekBotAdd",msg_chat_id)
Redis:set(TheCinder.."Cinder:Status:Id"..msg_chat_id,true) ;Redis:set(TheCinder.."Cinder:Status:Reply"..msg_chat_id,true) ;Redis:set(TheCinder.."Cinder:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheCinder.."Cinder:Status:BanId"..msg_chat_id,true) ;Redis:set(TheCinder.."Cinder:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheCinder.."Cinder:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheCinder.."Cinder:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheCinder.."Cinder:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheCinder.."Cinder:ChekBotAdd",msg_chat_id) then
Redis:incr(TheCinder..'Cinder:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" or text == "id" or text == "iD" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼𝖪 𝖧𝖾𝗋𝖾 ›', url = 't.me/'..Redis:get(TheCinder..'Cinder:Channel:Join') }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عذراً لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في القناة اولاً :*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheCinder.."Cinder:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheCinder..'Cinder:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheCinder.."Cinder:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheCinder.."Cinder:Set:Id:Group"..msg_chat_id)
if Redis:get(TheCinder.."Cinder:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheCinder..'Cinder:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه ↫ '..UserId..
...
local TotalMsg = Redis:get(TheCinder..'Cinder:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه ↫ '..UserId..
'\n᥀︙معرفه ↫ @'..UserName..
...
Redis:set(TheCinder.."Cinder:Set:Id:Group"..msg.chat_id,Text_Rand)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheCinder).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعة ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheCinder).status
if GetMemberStatus.can_change_info then
change_info = '‹ ✓ ›' else change_info = '‹ ✗ ›'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*᥀︙تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*᥀︙تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Developers:Groups",UserId) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheCinder.."Cinder:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم ترقيته مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم ترقيته مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Developers:Groups",UserId) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId[2]) then
...
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheCinder.."Cinder:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheCinder.."Cinder:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheCinder.."Cinder:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheCinder.."Cinder:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheCinder.."Cinder:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheCinder.."Cinder:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حالياً , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheCinder.."Cinder:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheCinder.."Cinder:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:BotFree",true) 
...
Redis:set(TheCinder.."Cinder:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheCinder.."Cinder1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheCinder.."Cinder1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheCinder..'Cinder1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheCinder..'Cinder1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheCinder..'Cinder1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheCinder.."Cinder1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheCinder.."Cinder1:List:Rd:Sudo"..msg.chat_id, text)
...
Redis:set(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheCinder.."Cinder1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheCinder.."Cinder1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheCinder.."Cinder1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheCinder.."Cinder1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheCinder.."Cinder1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheCinder.."Cinder1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheCinder.."Cinder1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheCinder.."Cinder1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\n᥀︙ارسل لي الكلمه الان ')
Redis:set(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheCinder.."Cinder11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheCinder.."Cinder11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheCinder.."Cinder11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المتعدده")
Redis:del(TheCinder..'Cinder11:Add:Rd:Sudo:Text'..text)
Redis:del(TheCinder..'Cinder11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheCinder..'Cinder11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheCinder.."Cinder11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheCinder.."Cinder11:List:Rd:Sudo", text)
return false
end
end
...
Redis:set(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheCinder.."Cinder11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheCinder.."Cinder11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheCinder.."Cinder11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheCinder.."Cinder11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheCinder.."Cinder11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheCinder.."Cinder11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheCinder.."Cinder11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheCinder.."Cinder11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheCinder.."Cinder11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = { 
Text,
Text1,
...
Redis:sadd(TheCinder.."Cinder:allM"..msg.chat_id, msg.id)
if Redis:get(TheCinder.."Cinder:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheCinder.."Cinder:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheCinder.."Cinder:allM"..msg.chat_id)
...
Redis:del(TheCinder.."Cinder:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheCinder.."Cinder:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheCinder.."Cinder:allM"..msg.chat_id)  
...
Redis:del(TheCinder.."Cinder:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheCinder.."Cinder:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheCinder.."Cinder:Status:yt"..msg.chat_id)
...
Redis:set(TheCinder.."Cinder:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheCinder.."Cinder:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheCinder.."Cinder:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheCinder.."Cinder:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Status:Id"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Status:Reply"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Status:BanId"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:BotFree") 
...
Redis:del(TheCinder.."Cinder:TwaslBot") 
...
if Redis:sismember(TheCinder.."Cinder:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheCinder.."Cinder:BanAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼𝖪 𝖧𝖾𝗋𝖾 ›', url = 't.me/RR77FF' }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عذراً لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في القناة اولاً :*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheCinder.."Cinder:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheCinder.."Cinder:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheCinder.."Cinder:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{ 1,1,1,1,1,1,1,1,1 })
...
if Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheCinder.."Cinder:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{ 1,1,1,1,1,1,1,1,1 })
...
if Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end

if text == "نزلني" then
if not Redis:get(TheCinder.."Cinder:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(TheCinder.."Cinder:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheCinder.."Cinder:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TheCinder.."Cinder:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{ 1,1,1,1,1,1,1,1,1 })
...
if Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
if not Redis:get(TheCinder.."Cinder:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(TheCinder.."Cinder:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheCinder.."Cinder:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheCinder.."Cinder:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheCinder.."Cinder:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheCinder.."Cinder:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheCinder.."Cinder:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheCinder.."Cinder:Lock:tagservrbot"..msg_chat_id,true)   
list ={ "Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam" }
for i,lock in pairs(list) do 
Redis:set(TheCinder..'Cinder:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheCinder.."Cinder:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:Lock:text"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:Lock:Join"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:lockpin"..msg_chat_id)  
...
Redis:del(TheCinder.."Cinder:Lock:edit"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Lock:tagservrbot"..msg_chat_id)   
list ={ "Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam" }
for i,lock in pairs(list) do 
Redis:del(TheCinder..'Cinder:'..lock..msg_chat_id)    
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text='‹ TeAm Cinder ›',url="t.me/RR77FF"}}}
local msg_id = msg.id/2097152/0.5
...
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheCinder.."Cinder:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheCinder.."Cinder:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Link"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Video"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Animation"..msg_chat_id,"ked")  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼𝖪 ??𝖾𝗋𝖾 ›', url = 't.me/'..Redis:get(TheCinder..'Cinder:Channel:Join') }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عذراً لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في القناة اولاً :*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheCinder.."Cinder:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:geam"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:vico"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:forward"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Document"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheCinder.."Cinder:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheCinder.."Cinder:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheCinder.."Cinder:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheCinder.."Cinder:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheCinder.."Cinder:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(TheCinder.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheCinder.."Cinder:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheCinder.."Cinder:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheCinder.."Cinder:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheCinder.."Cinder:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعة","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheCinder.."Cinder:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheCinder.."Cinder:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheCinder.."Cinder:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheCinder.."Cinder:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheCinder.."Cinder:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheCinder.."Cinder:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheCinder.."Cinder:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheCinder..'Cinder:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheCinder.."Cinder:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheCinder.."Cinder:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheCinder.."Cinder:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheCinder.."Cinder:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheCinder.."Cinder:Status:Link"..msg.chat_id) then
Statuslink = '‹ ✓ ›' else Statuslink = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:Welcome"..msg.chat_id) then
StatusWelcome = '‹ ✓ ›' else StatusWelcome = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:Id"..msg.chat_id) then
StatusId = '‹ ✓ ›' else StatusId = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '‹ ✓ ›' else StatusIdPhoto = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:Reply"..msg.chat_id) then
StatusReply = '‹ ✓ ›' else StatusReply = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '‹ ✓ ›' else StatusReplySudo = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:BanId"..msg.chat_id)  then
StatusBanId = '‹ ✓ ›' else StatusBanId = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:SetId"..msg.chat_id) then
StatusSetId = '‹ ✓ ›' else StatusSetId = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:Games"..msg.chat_id) then
StatusGames = '‹ ✓ ›' else StatusGames = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:KickMe"..msg.chat_id) then
Statuskickme = '‹ ✓ ›' else Statuskickme = '‹ ✗ ›'
end
if Redis:get(TheCinder.."Cinder:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheCinder.."Cinder:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheCinder.."Cinder:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheCinder.."Cinder:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheCinder.."Cinder:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheCinder.."Cinder:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheCinder..'Cinder:Num:Add:Memp'..msg.chat_id..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا ‹ *'..(Redis:get(TheCinder..'Cinder:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)..'* ›',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا ‹ *'..(Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'* ›',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا ‹ *'..(Redis:get(TheCinder.."Cinder:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'* ›',"md",true)  
...
Redis:setex(TheCinder.."Cinder:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
...
Redis:del(TheCinder.."Cinder:Set:Id:Groups")
...
Redis:setex(TheCinder.."Cinder:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
᥀︙`#username` ↫ اسم المستخدم
...
Redis:del(TheCinder.."Cinder:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheCinder.."Cinder:DevelopersQ:Groups") 
...
Redis:del(TheCinder.."Cinder:Developers:Groups") 
...
Redis:del(TheCinder.."Cinder:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Originators:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Managers:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:BanAll:Groups") 
...
Redis:del(TheCinder.."Cinder:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheCinder.."Cinder:SilentGroup:Group"..msg_chat_id) 
...
local R = Redis:scard(TheCinder.."Cinder1:List:Rd:Sudo"..msg.chat_id)
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {
{
...
local R = Redis:scard(TheCinder.."Cinder:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {
{
...
Redis:set(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheCinder.."Cinder:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local R = Redis:scard(TheCinder.."Cinder11:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {
{
...
local R = Redis:scard(TheCinder.."Cinder:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = {
{
...
Redis:set(TheCinder.."Cinder:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheCinder.."Cinder:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheCinder.."Cinder:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ›
...
Redis:setex(TheCinder.."Cinder:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ›
...
Redis:setex(TheCinder.."Cinder:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ›
...
Redis:setex(TheCinder.."Cinder:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheCinder.."Cinder:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheCinder..'Cinder:GetTexting:DevTheCinder'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheCinder..'Cinder:Texting:DevTheCinder')
...
local TestText = "❲ Developer Source ❳\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙*Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..Sudo_Id..")᥀︙*Dev User* : @"..UserSudo.."\n᥀︙*Dev iD* : "..Sudo_Id.."\n᥀︙*Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
end
end
if text == "جمالي" or text == 'نسبه جمالي' or text == 'نسبة جمالي' then
if Redis:get(TheCinder.."Cinder:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheCinder.."Cinder:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheCinder.."Cinder:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
...
{{text = '‹ TeAm Cinder ›', url = "https://t.me/RR77FF"}}
}
...
local tt =[[
᥀︙[مبرمج السورس](https://t.me/I74III) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مبرمج السورس .', url = "https://t.me/I74III"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/I74III&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
photo = "https://t.me/DovePhotoo/5"
local tt =[[
Welcome To Source
᥀︙[Source Dove](https://t.me/RR77FF) .
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ Source Channel ›', url = "https://t.me/RR77FF"}},
{{text = '‹ Developer', url = "https://t.me/I74III"},{text = 'Tws Dove ›', url = "https://t.me/Agfhcnbot"}},
{{text = '‹ Exp Source ›', url = "https://t.me/IczPzc"}}
}
local msgg = msg_id/2097152/0.5
...
{ 
{ text = '‹ TeAm Dove ›', url = 't.me/E5EEEF' }, 
 },
 }
 }
...
local L = Redis:scard(TheCinder.."Cinder:TheBasics:Group"..msg_chat_id) 
local LL = Redis:scard(TheCinder.."Cinder:Originators:Group"..msg_chat_id) 
local LLL = Redis:scard(TheCinder.."Cinder:Managers:Group"..msg_chat_id)
local LLLL = Redis:scard(TheCinder.."Cinder:Addictive:Group"..msg_chat_id)  
local LLLLL = Redis:scard(TheCinder.."Cinder:Distinguished:Group"..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
{ 
...
local LaR = (Redis:get(TheCinder..'Cinder:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local lar = (Redis:get(TheCinder..'Cinder:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
{ 
...
Redis:setex(TheCinder.."Cinder:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheCinder.."Cinder:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheCinder.."Cinder:Name:Bot") or "كاوي") then
local NamesBot = (Redis:get(TheCinder.."Cinder:Name:Bot") or "كاوي")
local NameBots = { 
"عمر "..NamesBot.. " شتريد ؟",
"ها سيد",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(TheCinder..'Cinder:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheCinder)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عضو في المجموعة سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheCinder..'Cinder:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheCinder..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheCinder..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheCinder..'Cinder:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheCinder.."Cinder:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheCinder.."Cinder:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheCinder.."Cinder:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheCinder.."Cinder:Status:Games"..msg.chat_id) then
Redis:del(TheCinder.."Cinder:Set:Maany"..msg.chat_id)
Maany_Rand = { "قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان" }
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheCinder.."Cinder:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheCinder.."Cinder:Status:Games"..msg.chat_id) then
Redis:del(TheCinder.."Cinder:Set:Aks"..msg.chat_id)
katu = { "باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ" }
name = katu[math.random(#katu)]
Redis:set(TheCinder.."Cinder:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheCinder.."Cinder:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheCinder.."Cinder:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheCinder.."Cinder:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheCinder.."Cinder:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheCinder.."Cinder:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheCinder.."Cinder:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','مسح رسائلي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'حذ','حذف رد')
Redis:set(TheCinder.."Cinder:Get:Reides:Commands:Group"..msg_chat_id..":"..'#','مسح قائمه العام')
...
if text == '/start' then
Redis:sadd(TheCinder..'Cinder:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheCinder.."Cinder:Start:Bot") then
local CmdStart = '*\n᥀︙اهلاً بك في بوت '..(Redis:get(TheCinder.."Cinder:Name:Bot") or "كاوي")..
...
{ 
{ text = 'قناة السورس ›', url = 't.me/RR77FF' },{ text = '‹ لتنصيب بوت', url = 't.me/I74III' }, 
 },
{ 
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheCinder.."Cinder:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheCinder.."Cinder:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheCinder.."Cinder:Start:Bot") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼?? 𝖧𝖾𝗋𝖾 ›', url = 't.me/'..Redis:get(TheCinder..'Cinder:Channel:Join') }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عذراً لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في القناة اولاً :*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheCinder..'Cinder:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *',"md",true)  
...
local list = Redis:smembers(TheCinder.."Cinder:List:Rd:Sudo")
text = "\n᥀︙قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." - ‹ "..v.." › ↫ ‹ "..db.." ›\n"
end
...
local list = Redis:smembers(TheCinder.."Cinder:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:vico"..v)   
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Text"..v)   
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Photo"..v)
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Video"..v)
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:File"..v)
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Audio"..v)
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:video_note"..v)
Redis:del(TheCinder.."Cinder:List:Rd:Sudo")
end
...
if not msg.ControllerBot then
if Redis:get(TheCinder.."Cinder:TwaslBot") and not Redis:sismember(TheCinder.."Cinder:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = { Sudo_Id,msg.sender.user_id }
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheCinder.."Cinder:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheCinder.."Cinder:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheCinder..'Cinder:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheCinder..'Cinder:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheCinder.."Cinder:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheCinder..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheCinder.."Cinder:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheCinder.."Cinder:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheCinder.."Cinder:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheCinder then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheCinder..'Cinder:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheCinder.."Cinder:Lock:edit"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
local Rds = Redis:scard(TheCinder.."Cinder:List:Rd:Sudo")
local list = Redis:smembers(TheCinder.."Cinder:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheCinder.."Cinder:Add:Rd:Sudo:vico"..v)   
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheCinder.."Cinder11:List:Rd:Sudo")
...
local list = Redis:smembers(TheCinder.."Cinder11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheCinder.."Cinder11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheCinder.."Cinder11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheCinder.."Cinder11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheCinder.."Cinder11:List:Rd:Sudo")
end
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheCinder.."Cinder1:List:Rd:Sudo"..data.chat_id)
...
local UserId = Text:match('(%d+)/RdLaR')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheCinder.."Cinder1:List:Rd:Sudo"..data.chat_id)
local list = Redis:smembers(TheCinder.."Cinder1:List:Rd:Sudo"..data.chat_id)
for k,v in pairs(list) do  
Redis:del(TheCinder.."Cinder1:Add:Rd:Sudo:Text"..v..data.chat_id) 
Redis:del(TheCinder.."Cinder1:Add:Rd:Sudo:Text1"..v..data.chat_id) 
Redis:del(TheCinder.."Cinder1:Add:Rd:Sudo:Text2"..v..data.chat_id) 
Redis:del(TheCinder.."Cinder1:List:Rd:Sudo"..data.chat_id)
end
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheCinder.."Cinder:List:Manager"..data.chat_id.."")
text = "᥀︙قائمة ردود المدير ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Gif"..v..data.chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Vico"..v..data.chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..v..data.chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Text"..v..data.chat_id) then
db = "رساله ✉"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Photo"..v..data.chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Video"..v..data.chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:File"..v..data.chat_id) then
db = "ملف 📁"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:Audio"..v..data.chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheCinder.."Cinder:Add:Rd:Manager:video_note"..v..data.chat_id) then
db = "فيديو نوت 🎥"
end
text = text..""..k.." - ‹ "..v.." › ↫ ‹ "..db.." ›\n"
end
...
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheCinder.."Cinder:List:Manager"..data.chat_id.."")
local list = Redis:smembers(TheCinder.."Cinder:List:Manager"..data.chat_id.."")
for k,v in pairs(list) do
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Gif"..v..data.chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Vico"..v..data.chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Stekrs"..v..data.chat_id)     
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Text"..v..data.chat_id)   
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Photo"..v..data.chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Video"..v..data.chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:File"..v..data.chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:video_note"..v..data.chat_id)
Redis:del(TheCinder.."Cinder:Add:Rd:Manager:Audio"..v..data.chat_id)
Redis:del(TheCinder.."Cinder:List:Manager"..data.chat_id)
end
...
Redis:incrby(TheCinder.."Cinder:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheCinder.."Cinder:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheCinder.."Cinder:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem' }, }, } }
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheCinder.."Cinder:TheBasicsQ:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheCinder.."Cinder:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheCinder.."Cinder:Lock:tagservrbot"..UserId[2],true)   
list ={ "Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam" }
for i,lock in pairs(list) do 
Redis:set(TheCinder..'Cinder:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
local MMsgDel = (Redis:get(TheCinder..'Cinder:Num:Message:User'..data.chat_id..':'..UserId) or 0)
Redis:del(TheCinder..'Cinder:Num:Message:User'..data.chat_id..':'..UserId) 
...
if tonumber(IdUser) == tonumber(UserId) then
local MsgDell = (Redis:get(TheCinder..'Cinder:Num:Message:Edit'..data.chat_id..UserId) or 0)
Redis:del(TheCinder..'Cinder:Num:Message:Edit'..data.chat_id..UserId)
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'Rgg' }, }, } }
...
local Info_Members = Redis:smembers(TheCinder.."Cinder:TheBasics:Group"..data.chat_id) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar' }, }, } }
local Info_Members = Redis:smembers(TheCinder.."Cinder:Originators:Group"..data.chat_id) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar' }, }, } }
local Info_Members = Redis:smembers(TheCinder.."Cinder:Managers:Group"..data.chat_id) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar' }, }, } }
local Info_Members = Redis:smembers(TheCinder.."Cinder:Addictive:Group"..data.chat_id) 
if #Info_Members == 0 then
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAlar' }, }, } }
local Info_Members = Redis:smembers(TheCinder.."Cinder:Distinguished:Group"..data.chat_id) 
if #Info_Members == 0 then
...
local L = Redis:scard(TheCinder.."Cinder:TheBasics:Group"..data.chat_id) 
local LL = Redis:scard(TheCinder.."Cinder:Originators:Group"..data.chat_id) 
local LLL = Redis:scard(TheCinder.."Cinder:Managers:Group"..data.chat_id)
local LLLL = Redis:scard(TheCinder.."Cinder:Addictive:Group"..data.chat_id)  
local LLLLL = Redis:scard(TheCinder.."Cinder:Distinguished:Group"..data.chat_id)
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
{ 
...
if tonumber(IdUser) == tonumber(UserId) then
local LaR = (Redis:get(TheCinder..'Cinder:Num:Message:Edit'..data.chat_id..UserId) or 0)
local lar = (Redis:get(TheCinder..'Cinder:Num:Message:User'..data.chat_id..':'..UserId) or 0)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheCinder.."Cinder:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:TheBasics:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Originators:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Managers:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Addictive:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA' }, }, } }
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين بالمجموعة", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheCinder.."Cinder:SilentGroup:Group"..ChatId) 
